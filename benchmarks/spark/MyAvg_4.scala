...
object MyAvg_4 {
  def main(args: Array[String]): Unit = {
    ...
    val filtered = exploded.filter(
      (!$"bufferSum".isNull && $"bufferSum" > 140_000 && $"bufferSum" =!= 175_000 && $"bufferSum" <= 200_000) ||
      $"bufferCount" >= 2_000_000 && $"bufferCount" =!= 2_500_000)
    ...
    val filtered_pre = exploded_pre.filter(
      ($"bufferSum".isNull || ($"bufferSum" > 140_000 && $"bufferSum" =!= 175_000 && $"bufferSum" <= 200_000)) &&
      $"bufferCount" =!= 2_500_000 && $"bufferCount" >= 2_000_000)
