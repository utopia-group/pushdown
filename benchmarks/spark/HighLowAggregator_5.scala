...
object HighLowAggregator_5 {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder
      .appName("HighLowAggregator_5")
      .getOrCreate()
    ...
    val ts1 = to_timestamp(lit("2020-07-30 08:00:00"), "yyyy-MM-dd HH:mm:ss")
    val ts2 = to_timestamp(lit("2020-01-30 08:00:00"), "yyyy-MM-dd HH:mm:ss")
