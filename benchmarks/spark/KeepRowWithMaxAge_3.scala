...
object KeepRowWithMaxAge_3 {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder
      .appName("KeepRowWithMaxAge_3")
      .getOrCreate()
    ...
    val filtered = exploded.filter($"id" >= 1 && $"age" > 21)
    ...
    val filtered_pre = exploded_pre.filter($"id" === 1)
