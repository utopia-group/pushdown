// https://github.com/gcrowder/programming-language-classifier/blob/b5bb8c8e64502b9d950a1ebaabe24215d0127719/data/scala/AggregationQuerySuite.scala#L34
...
class ScalaAggregateFunction1(schema: StructType) extends UserDefinedAggregateFunction {
...
object AggregationQuerySuite_1 {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder
      .appName("AggregationQuerySuite_1")
      .getOrCreate()
    ...
    val filtered = exploded.filter(
      !$"value1".isNull && $"value1" >= 22 && $"value1" =!= 50 &&
      !$"value2".isNull && $"value2" > 44  && $"value2" <= 50)
