...
object UserDefinedAggregationFunctionTest_4 {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder
      .appName("UserDefinedAggregationFunctionTest_3")
      .getOrCreate()
    ...
    val filtered = exploded.filter(
      ...
      ($"first_log_time" === 1 || $"first_log_time" === 2 || $"first_log_time" === 3) &&
      !$"last_log_time".isNull &&
      ($"last_log_time" === 58 || $"last_log_time" === 59 || $"last_log_time" === 60))
