...
object SnapshotAggregator_2 {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder
      .appName("SnapshotAggregator_2")
      .getOrCreate()
    ...
    val filtered = exploded.filter(
      $"offset" > 20 && $"offset" =!= 25 && $"offset" <= 40 &&
      !$"value".isNull && $"value" >= 1 && $"value" =!= 250 && $"value" < 790)
    ...
    val filtered_pre = exploded_pre.filter(
      $"offset" =!= 25 &&
      ($"value".isNull || ($"value" < 790 && $"value" =!= 250 && $"value" >= 1)) &&
      $"offset" =!= -1 && $"offset" <= 40)
