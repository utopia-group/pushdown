...
object MyAvg_5 {
  def main(args: Array[String]): Unit = {
    ...
    val filtered = exploded.filter(
      !$"bufferSum".isNull && ($"bufferSum" < 150_000 || $"bufferSum" >= 200_000) &&
      $"bufferCount" > 2_000_000 && $"bufferCount" =!= 2_500_000 && $"bufferCount" <= 3_000_000)
    ...
    val filtered_pre = exploded_pre.filter(
      $"bufferCount" =!= 2_500_000 &&
      ($"bufferSum".isNull || $"bufferSum" < 150_000 || $"bufferSum" >= 200_000) &&
      $"bufferCount" <= 3_000_000 && $"bufferCount" > 2_000_000)
