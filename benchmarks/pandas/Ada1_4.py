...
filtered = out[
    ...
    (out['in_1_or_2_count'] >= 1) &
    ~((out['in_1_or_2_count'] >= 3) & (out['in_1_or_2_count'] < 5)) &
    (out['in_1_or_2_count'] < 200)]
...
out_pre = out_pre[(out_pre['semester_count'] > 1) & (out_pre['in_1_or_2_count'] >= 2)]
filtered_pre = out_pre[
    (out_pre['semester_count'] != 0) &
    (out_pre['in_1_or_2_count'] != 0) &
    ((out_pre['in_1_or_2_count'] < 3) | (out_pre['in_1_or_2_count'] >= 5)) &
