# https://github.com/utopia-group/pushdown/blob/main/benchmarks/pandas/a_udafs/relevant/escuccim/applied-data-analysis/Manipulating%20Data.ipynb.py
...
predicate = lambda r: (r['score1'] < 50) | (r['score2'] < 50)
...
filtered = out[(out['min1'] < 50) & (out['min2'] < 50)]
...
filtered_pre = out_pre[(out_pre['min1'] < 50) & (out_pre['min2'] < 50)]
