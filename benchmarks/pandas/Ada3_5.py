...
predicate = lambda r: (r['score1'] <= 65) | (r['score2'] <= 55)
...
filtered = out[
    ((out['min1'] < 15) | (out['min1'] == 65)) &
    ((out['min2'] <= 30) | (out['min2'] == 55))]
...
filtered_pre = out_pre[
    ((out_pre['min1'] < 15) | (out_pre['min1'] == 65)) &
    ((out_pre['min2'] <= 30) | (out_pre['min2'] == 55))]
