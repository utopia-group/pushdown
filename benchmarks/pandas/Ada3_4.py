...
predicate = lambda r: (r['score2'] <= 60) | (r['score1'] <= 45)
...
filtered = out[
    ((out['min1'] == 45) | (out['min1'] <= 15)) &
    ((out['min2'] < 40) | (out['min2'] == 60))]
...
filtered_pre = out_pre[
    ((out_pre['min1'] == 45) | (out_pre['min1'] <= 15)) &
    ((out_pre['min2'] < 40) | (out_pre['min2'] == 60))]
