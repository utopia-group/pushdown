# https://github.com/utopia-group/pushdown/blob/main/benchmarks/pandas/a_udafs/relevant/afcarvallo/DataMiningChileCompra/throwaways/20Nov.ipynb.py
...
filtered_pre = out_pre[out_pre['class_sold'] > 10]
