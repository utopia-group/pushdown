# https://github.com/utopia-group/pushdown/blob/main/benchmarks/pandas/a_udafs/relevant/hobgreenson/chicago_employees/ChicagoEmployeeGenderSalary.ipynb.py
